...
\begin{frame}{Model quality requirements: Construction team}                      
  \begin{itemize} 
    ...
    \item<+-| alert@+> Project management
      \begin{itemize}
	\item<+-| alert@+> Uses requirements model for estimation, resourcing, control, measurement \& reporting.
	\item<+-| alert@+> Requires additionally {\em completeness} \& {\em traceability}.
      \end{itemize}
  \end{itemize}
\end{frame}
