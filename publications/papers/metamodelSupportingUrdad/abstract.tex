...
URDAD is a methodology which s used by business analysts to develop
requirements models. Historically these requirements models were encoded in
UML. However, in order to encode an URDAD model in UML, one has to
...
a range of mundane relationships in order to fully capture the URDAD semantics.
The resultant process is thus inefficient and errror prone. This paper presents and assesses
