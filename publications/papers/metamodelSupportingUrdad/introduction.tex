...
Requirements are critical and still core cause of system errors
...
\cite{ferguson_empirical_2006} show that there is a direct relationship between the expressiveness defects in 
the language within which requirements are provided and the resultant density of test failures.
