...
\todo{Query, Assignable and its subclasses have been moved to Process metamodel (does not make sense in static data model) }
...
\todo{Clean up process metamodel diagram after incorporating Query, Assignable }
