...
\end{lstlisting}\normalsize
The above specification is sufficient for generating the functional tests for the service contract. It is not possible to specify the pre- and post-conditions in OCL alone because the extraction of information from the environment through services. also parametrized constraint
