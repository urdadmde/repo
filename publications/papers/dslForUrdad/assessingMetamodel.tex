...
The \emph{usage complexity} will depend largely on the diagrammtic syntax tool support. However, it is expected the lower language complexity, the direct representation of core concepts like services contracts and the much lower level of inconsistency risks will contribute to a lower usage complexity.