...
\todo[inline,color=red!40]{Fritz: The abstract is still very bad.}

\todo[inline,color=red!40]{Fritz: change service user to service consumer throughout}

\todo[inline,color=red!40]{Cuen: Agreed term usage:
- Use-case not usecase or use case?
- Service-oriented not service oriented.
- Stakeholder not stake holder.
- quality-driver not quality driver.
- quality-driven not quality driven.
- model-driven not model driven.
}
