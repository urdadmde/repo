...
\begin{itemize}
 \item Requirements analysis for level of granularity

 \item Process design for level of granularity
      \begin{itemize}
       \item For each pre and post condition, identified service used to assess condition
	\item
      \end{itemize}
...
\todo{Fritz:The methodology envisages requirements specialists across responsibility domains to contribute to a single requirements model.}
