...
URDAD includes the specification of a domain specific language, the URDAD-DSL \cites{solmsfritz_domain-specific_????} which defines the semantics and structure for an URDAD model in the form of a metamodel and provides a concrete text syntax used to construct an URDAD model.